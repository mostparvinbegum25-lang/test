...
Authentication — obtain and refresh API credentials
Catalog sync — pull available products, denominations, regions
Order placement — submit purchase requests with idempotency keys
Fulfillment — receive digital codes via response or webhook callback
Reconciliation — verify delivered codes against order records
